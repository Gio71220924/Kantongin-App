/* Concept 2 — Neo-Brutalism : icon set (thick stroke, square caps) */
function C2Icon({ name, size = 22, stroke = 2.6, style }) {
  ...
  const paths = {
    ...
    wallet:   <><rect x="3" y="6" width="18" height="13" rx="2" {...p}/><path d="M16 12h3M3 9h13a2 2 0 0 1 2 2" {...p}/></>,
